...
Public Class Planilla2SeriesFondo
    ...
    Private Sub btnIraSerieFinal_Click(sender As System.Object, e As System.EventArgs) Handles btnIraSerieFinal.Click
        PlanillaSerieFinalFondo.txtcodigofondo.Text = Me.txtCodigoFondo.Text
        PlanillaSerieFinalFondo.txtNombre.Text = Me.txtNombre.Text
        PlanillaSerieFinalFondo.txtLugar.Text = Me.txtLugar.Text
        PlanillaSerieFinalFondo.cboProvincia.Text = Me.cboProvincia.Text
        PlanillaSerieFinalFondo.cboLocalidad.Text = Me.cboLocalidad.Text
        PlanillaSerieFinalFondo.dtpfechainicio.Text = Me.dtpfechainicio.Text
        PlanillaSerieFinalFondo.txtHora.Text = Me.txtHora.Text
        PlanillaSerieFinalFondo.txtEstado.Text = Me.txtEstado.Text
        PlanillaSerieFinalFondo.cboJuez1.Text = Me.cboJuez1.Text
        PlanillaSerieFinalFondo.cboJuez2.Text = Me.cboJuez2.Text
        PlanillaSerieFinalFondo.cboJuez3.Text = Me.cboJuez3.Text
        PlanillaSerieFinalFondo.cboUsuario.Text = Me.cboUsuario.Text
        PlanillaSerieFinalFondo.cboPrueba.Text = Me.cboPrueba.Text
        PlanillaSerieFinalFondo.cboSexo.Text = Me.cboSexo.Text
        PlanillaSerieFinalFondo.cboCategoria.Text = Me.cboCategoria.Text
        PlanillaSerieFinalFondo.Show()
    ...
    Private Sub btnAgregarSerieFinal1_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarSerieFinal1.Click
        ...
        'eliminando la fila del grid original
        For Each row As DataGridViewRow In FilasSeleccionadas
            PlanillaSerieFinalFondo.dgvSerie1.Rows.Add(row.Cells(1).Value, row.Cells(2).Value)
        ...
        Next
        For Each row As DataGridViewRow In nuevo
            PlanillaSerieFinalFondo.dgvSerie1.Rows.Add(New Object() {row.Cells(0).Value, row.Cells(1).Value, row.Cells(2).Value})
        Next
    End Sub
    ...
    Private Sub dgvSerie1_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvSerie1.CellContentClick
        dgvSerie1.ClearSelection()
    End Sub

    Private Sub dgvSerie2_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvSerie2.CellContentClick
        dgvSerie2.ClearSelection()
    End Sub
