Public Class CEPlanillaMaraton
    Private _PlanillaMaraton As List(Of CEPlanillaMaraton)
    Public Property PlanillaMaraton() As List(Of CEPlanillaMaraton)
        Get
            Return _PlanillaMaraton
        End Get
        Set(value As List(Of CEPlanillaMaraton))
            _PlanillaMaraton = value
        End Set
    End Property

    Private _id_planilla_maraton As Integer
    Public Property id_planilla_maraton() As Integer
        Get
            Return _id_planilla_maraton
        End Get
        Set(ByVal value As Integer)
            _id_planilla_maraton = value
        End Set
    End Property
    ...
    Private _tiempo_final_maraton As DateTime
    Public Property tiempo_final_maraton() As DateTime
        Get
            Return _tiempo_final_maraton
        End Get
        Set(value As DateTime)
            _tiempo_final_maraton = value
        End Set
    End Property

    Private _Clasificacion_maraton As Integer
    Public Property Clasificacion_maraton() As Integer
        Get
            Return _Clasificacion_maraton
        End Get
        Set(ByVal value As Integer)
            _Clasificacion_maraton = value
        End Set
    End Property
