Public Class CEPlanillaVelocidad

    Private _id_planilla_velocidad As Integer
    Public Property id_planilla_velocidad() As Integer
        Get
            Return _id_planilla_velocidad
        End Get
        Set(ByVal value As Integer)
            _id_planilla_velocidad = value
        End Set
    End Property
    ...
    Private _Clasificacion_Velocidad_Final As Integer
    Public Property Clasificacion_Velocidad_Final() As Integer
        Get
            Return _Clasificacion_Velocidad_Final
        End Get
        Set(ByVal value As Integer)
            _Clasificacion_Velocidad_Final = value
        End Set
    End Property
